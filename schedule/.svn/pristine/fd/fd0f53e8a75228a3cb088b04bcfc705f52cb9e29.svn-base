...
public interface ILeaseOrderService {
	 ...
	 * @return
	 */
	public Map<String, Object> queryStatDayStatTotalList(Search search,
	 ...
	 * @return
	 */
	public Map<String, Object> queryStatDateStatTotalList(Search search,
	 ...
	 * @return
	 */
	public Map<String, Object> queryStatBusinessStatTotalList(Search search,
	 ...
	 * @return
	 */
	public Map<String, Object> queryStatLineStatTotalList(Search search,
