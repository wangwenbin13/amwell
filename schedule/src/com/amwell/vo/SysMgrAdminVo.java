...
public class SysMgrAdminVo implements Serializable,HttpSessionBindingListener{
	/**
	 * 
	 */
	private static final long serialVersionUID = 7412214675023252395L;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SysMgrAdminVo other = (SysMgrAdminVo) obj;
		if (userId == null) {
	...
	public void valueUnbound(HttpSessionBindingEvent event) {
		...
		Map<SysMgrAdminVo,HttpSession> map = (Map<SysMgrAdminVo, HttpSession>) context.getAttribute("usermap");
		map.remove(this);
