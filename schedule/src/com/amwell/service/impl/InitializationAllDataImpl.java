...
public class InitializationAllDataImpl extends SysDaoImpl<InitializationAllData>
		implements InitializationAllDataService {
	...
	public List<InitializationAllData> queryAllInitializationData() {
		...
		List<InitializationAllData> allDatas = queryList(sql, new Object[0]);
		return allDatas;
	}
	...
	public void updateIsExecute(String isExcete, String dataId, int sysType) {
		...
		Object[] params = { isExcete, dataId, sysType };
