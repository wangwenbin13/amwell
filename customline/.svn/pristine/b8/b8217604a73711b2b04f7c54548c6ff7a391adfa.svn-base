...
<div class="r-sub-nav-out"><p class="r-sub-nav gray2">当前位置：首页&nbsp;>&nbsp;App消息&nbsp;>&nbsp;增加消息模板</p></div>
<div class="mt10 ml20 mr20 black1">
    ...
    <ul class="mt25 ml10">
      	<li class="w58p mb10 clearfix"><span class="w75 t-r fl">模板名称：</span>                		
          	<s:textfield type="text" theme="simple" cssClass="r-input w50p fl" name="msgTemplateVo.template_name" id="template_name" maxlength="30" check="11"></s:textfield>
      	</li>
          <li class="w58p mb10 clearfix"><span class="w75 t-r fl">模板内容：</span>
          	<s:textarea theme="simple" cssClass="r-input more-show w85p fl"  id="template_content"  style="height:100px;" name="msgTemplateVo.template_content"  onkeydown="textCounts();" onkeyup="textCounts();" check="11"></s:textarea> 
          	<p class="gray2 mt5 fl"><span class="w75 t-r fl"></span>字数限定在100字节以内（2字节=1个中文字）</p>    		
          </li>
	</ul>	
...
function adminFormSubmit(){
	...
	$("#addSMSTemplate").ajaxSubmit({
		type : 'post',
		data:{},
		url : "../pushMessage/addTemplateModel.action?random="+Math.floor(Math.random()*10000+1),
		dataType:"text",
