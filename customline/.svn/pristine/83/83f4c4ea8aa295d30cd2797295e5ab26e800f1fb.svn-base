            ...
            <div class="table-title">
                <ul>
                     ...
                     <s:iterator value="#request.threeLevelMenu" var="p" status="v">
                		...
                		<li <c:if test="${theTab != 1 && v.index == 0 }">class="on"</c:if><c:if test="${theTab == 1 && v.index == 1 }">class="on"</c:if>>
...
$(function(){
	...
	//iframe高度
	$("#loadPage").css("min-height",$(window).height()-81+"px");
