...
public class DriverInfoEntity implements java.io.Serializable {
	...
	private String accountStatus;//0:启用 1:禁用 2.删除
	...
	private String totalAmount;//decimal(6,2) NULL司机账户总金额
	...
	/** full constructor */
	public DriverInfoEntity(String driverId, String driverName, String telephone,
			String sex, String birthday, String driverNo, Short driverType,
			String inspectionDate, String idNumber, String entryDate,
			String accountStatus, String passWord, String businessId,
