...
<body>
  <div class="mt10 black1">
   ...
   <form name="" action="../charteredOrder/getDayIncomeList.action" method="post" id="searchForm">
      ...
      <div class="table2-text sh-ttext mt20">       
       	<div style="overflow-x:auto;overflow-y:hidden">
            <table width="100%" border="0" class="table1">
              ...
              <s:iterator value="list" var="bcOrderVo" status="s">
						...
						<s:if test="%{#s.count%2 == 0}">
                    		...
                    		<td class="f-arial">${bcOrderVo.beginAddress}</td>
                    		<td class="f-arial">${bcOrderVo.endAddress}</td>
                    		<td class="f-arial">${bcOrderVo.totalPassengers}</td>
                    		<td class="f-arial">${bcOrderVo.totalCars}</td>
...
<form action="../charteredOrder/getDayIncomeList.action" method="post" style="display: none;" id="turnPage">
...
<form action="../charteredOrder/exportDayInComeListExcel.action" method="post" style="display: none;" id="export">
   	<input type="text" name="search.field01" value="${search.field01 }"/>
    <input type="text" name="search.field02" value="${search.field02}"/>
    <input type="text" name="search.field03" value="${search.field03}"/>
    <input type="text" name="search.field04" value="${search.field04}"/>
