...
<title>拼车管理-车主线路列表</title>
<%@include file="../resource.jsp" %>

</head>
<body>
<div class="r-sub-nav-out"><p class="r-sub-nav gray2">当前位置：首页&nbsp;>&nbsp;拼车管理&nbsp;>&nbsp;车主线路列表<span class="blue1 ml25"></span></p></div>
 <div class="mt10 ml20 mr20 black1">
          <div class="fl widthfull p-r">
            <div class="table-title">
                <ul>
                	<li class="on"><a href="javascript:void(0)" class="f14 blue2">车主线路列表</a></li>
                </ul>
            </div>
 <form action="../carOwnerLine/getLineList.action" method="post" id="searchForm">  
 <ul class="r-sub-sel black1 mt20 clearfix">       	
       <li class="w30p">
        ...
        <li class="w16p"><span class="t-r w65 fl">座位数量：</span><s:textfield name="search.field03"  cssClass="r-input w23p gray2 fl mr5" onkeyup="this.value=this.value.replace(/\D/g,'');" onafterpaste="this.value=this.value.replace(/\D/g,'');"/><span class="fl">至</span><s:textfield name="search.field04"  cssClass="ml5 fl r-input w23p gray2" onkeyup="this.value=this.value.replace(/\D/g,'');" onafterpaste="this.value=this.value.replace(/\D/g,'');"/></li>
      ...
      <!-- 
            ...
            <s:select list="%{proSysAreas}" listKey="arearCode" listValue="areaName" headerKey="" headerValue="--选择省份--" name="search.field08" cssClass="fl r-input mr10 w36p" onchange="loadCity(this.value);"/>
        	 <select name="search.field09" id="cityCode" class="fl r-input w36p"><option value="">--选择城市--</option></select>
        </li> 
      -->
        <li class="w30p"><span class="t-r w75 fl">价格：</span><s:textfield name="search.field10"  cssClass="r-input w32p gray2 fl mr10" onkeyup="if(this.value==this.value2)return;if(this.value.search(/^\d*(?:\.\d*)?$/)==-1)this.value=(this.value2)?this.value2:'';else this.value2=this.value;" onafterpaste="if(this.value==this.value2)return;if(this.value.search(/^\d*(?:\.\d*)?$/)==-1)this.value=(this.value2)?this.value2:'';else this.value2=this.value;"/><span class="fl">至</span><s:textfield  name="search.field11"  cssClass="ml10 fl r-input w32p gray2" onkeyup="if(this.value==this.value2)return;if(this.value.search(/^\d*(?:\.\d*)?$/)==-1)this.value=(this.value2)?this.value2:'';else this.value2=this.value;" onafterpaste="if(this.value==this.value2)return;if(this.value.search(/^\d*(?:\.\d*)?$/)==-1)this.value=(this.value2)?this.value2:'';else this.value2=this.value;"/></li>
        <li class="w16p"><span class="t-r w65 fl">线路类型：</span><s:select name="search.field12" list="#{'':'所有状态',1:'上下班',2:'长途 '}" listKey="key" listValue="value" cssClass="p3 w57p"/></li>
        <li class="w16p"><span class="t-r w75 fl">单程/返程：</span><s:select name="search.field13" list="#{'':'所有状态',1:'单程',2:'往返 '}" listKey="key" listValue="value" cssClass="fl p3 w57p"/> </li>
        <li class="w16p"><span class="t-r w75 fl">车牌：</span><s:textfield name="search.field14"  cssClass="fl r-input w54p gray2"/></li>
        <li class="w16p"> 
      ...
      <table width="100%" border="0" class="table3" id="tableDiv">
            <tr align="center" class="th">
              ...
              <th scope="col" width="8%">提交时间</th>
              <th scope="col" width="8%">用户</th>
              <th scope="col" width="5%">线路类型</th>
              <th scope="col">起点/终点</th>
              <th scope="col" width="5%">单程往返</th>
              <th scope="col" width="6%">去程时间</th>
              <th scope="col" width="6%">返程时间</th>
              <th scope="col" width="6%">联系电话</th>
              <th scope="col" width="6%">车牌</th>
              <th scope="col" width="5%">车型</th>
              <th scope="col" width="5%">价格(元)</th>
              <th scope="col" width="4%">座位</th>
              <th scope="col" width="5%">线路状态</th>
              <th scope="col" width="5%">线路开关</th>
...
<input type="hidden" id="myCurrentPageIndex" value="${currentPageIndex}"/>
 <form action="../carOwnerLine/getLineList.action" method="post" style="display: none;" id="turnPage">
 ...
 <form action="../carOwnerLine/exportCarOwnerLine.action" method="post" style="display: none;" id="export">
    <input type="text" name="search.field01" value="${search.field01}"/>
    <input type="text" name="search.field02" value="${search.field02}"/>
    <input type="text" name="search.field03" value="${search.field03}"/>
    <input type="text" name="search.field04" value="${search.field04}"/>
...
// 	alert(pcLineId);
	...
	else
	{
		...
		//跳转到订单详情
		$("#iframe_right",parent.window.document).attr("src","../carOwnerLine/getLineDetail.action?pcLineId="+pcLineId+"&currentPageIndex="+$("#myCurrentPageIndex").val()); 
	}
});
