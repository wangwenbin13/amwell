...
<div class="r-sub-nav-out"><p class="r-sub-nav gray2">当前位置：首页&nbsp;>&nbsp;App站内信&nbsp;>&nbsp;增加站内信模板</p></div>
...
function adminFormSubmit(){
	...
	$("#addSMSTemplate").ajaxSubmit({
		type : 'post',
		data:{},
		url : "../insideMessage/addTemplateModel.action?random="+Math.floor(Math.random()*10000+1),
		dataType:"text",
