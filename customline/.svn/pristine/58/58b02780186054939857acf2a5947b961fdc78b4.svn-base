...
<body>
   ...
   <s:form id="searchForm" name="searchForm" action="../line/getPublishedLines.action" method="post"   theme="simple"> 
   <input type="hidden" name="search.field10" id="myCurrentPageIndex" value="${currentPageIndex}"/>
        ...
        <li class="w14p"><span class="t-r w65 fl">线路状态：</span><s:select name="search.field05" list="#{'':'所有状态',0:'待调度',1:'调度中 ',2:'待发布',3:'已发布',4:'已下线'}" listKey="key" listValue="value" cssClass="p3 w58p"/></li>
	   ...
	   <li class="w14p"><span class="t-r w65 fl">每页展示：</span><s:select name="search.field07" list="#{'':'默认',10:'10条',20:'20条',30:'30条 ',50:'50条'}" listKey="key" listValue="value" cssClass="p3 w58p" /></li>
        <li><s:submit value="查找" onclick="query()" cssClass="btn-blue4"/><s:reset value="重置" cssClass="btn-blue4" onclick="clearFormValue('searchForm')"/></li>
  	</ul >  
  	</s:form>
      ...
      <div class="table2-text sh-ttext mt10">       
              <table width="100%" border="0" class="table3" id="tableDiv">
                    ...
                    <s:iterator value="list" var="lineBusiness" status="s">
                    	...
                    	<ul class="stations">
                    	<c:forEach items="${lineBusiness.upStation}" var="upStationItem">
                        	<li class="fl red1" >上车点:&nbsp;&nbsp;&nbsp;${upStationItem}</li><br>
                    	</c:forEach>
                    	<c:forEach items="${lineBusiness.downStation }" var="downStationItem">
                    		<li class="fl green1">下车点:&nbsp;&nbsp;&nbsp;${downStationItem }</li><br>
                    	</c:forEach>
                    	...
                    	<th>
                    	   ...
                    	   <s:if test="%{#lineBusiness.lineStatus==0}">
                    	     <%-- <a href="javascript:void(0);" class="fn blue1 mr10" onclick="selectMerchant('${lineBusiness.lineBaseId}')">发送商家</a> --%>
                    	   ...
                    	   <s:if test="%{#lineBusiness.lineStatus==3}">
                    	    ...
                    	    <%--  <a href="javascript:void(0);" class="fn blue1 mr10" onclick="topLine('${lineBusiness.lineBaseId}')">置顶</a>
                    	   		  <a href="javascript:void(0);" class="fn blue1 mr10" onclick="allowance('${lineBusiness.lineBaseId}')">设置补贴</a> --%>
