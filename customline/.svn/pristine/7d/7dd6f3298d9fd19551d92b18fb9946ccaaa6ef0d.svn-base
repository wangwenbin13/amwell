...
<body>
  <div class="mt10 black1">
   ...
   <form name="" action="../bcCouponStatAction/bcCouponStatList.action" method="post" id="searchForm">
   	 <ul class="r-sub-sel black1 mt20 clearfix">
        	<li class="w28p">
           	<span class="fl w65 t-r">使用时间：</span>
        ...
        <li class="w17p">
        	<span class="fl w66 t-r">优惠券名称：</span><s:textfield name="search.field03" theme="simple" cssClass="fl r-input gray2 w59p mt2"/>    
       </li>
        <li class="w17p">
        	<span class="fl w65 t-r">用户帐号：</span><s:textfield name="search.field04" theme="simple" cssClass="fl r-input gray2 w59p mt2"/>    
       </li>
        <li class="w31p">
        	<span class="fl w65 t-r">订单号：</span><s:textfield name="search.field05" theme="simple" cssClass="fl r-input gray2 w31p mt2"/>
       	...
       	<div style="overflow-x:auto;overflow-y:hidden">
            <table width="100%" border="0" class="table1">
              <tr align="center">
              	...
              	<th scope="col" width="7%">用户帐号</th>
              	<th scope="col" width="10%">订单号</th>
                <th scope="col" width="10%">优惠券名称</th>
                <th scope="col" width="5%">优惠券面值</th>
                <th scope="col" width="5%">订单价格</th>
                <th scope="col" width="6%">实际支付金额</th>
                <th scope="col" width="5%">优惠金额</th>
                <th scope="col" width="8%">飞单金额</th>
                 <th scope="col" width="10%">优惠券领取时间</th>
                <th scope="col" width="10%">优惠券使用时间</th>
                <th scope="col" width="8%">优惠券上线时间</th>
              	<th scope="col" width="7%">优惠券创建时间</th>
              </tr>
              ...
              <s:iterator value="list" var="bcCouponStatVo" status="s">
						...
						<s:if test="%{#s.count%2 == 0}">
                    		...
                    		<td class="f-arial">${bcCouponStatVo.telephone}</td>
                    		<td class="f-arial">${bcCouponStatVo.orderId}</td>
                    		<td class="f-arial">${bcCouponStatVo.couponName}</td>
                    		<td class="f-arial">${bcCouponStatVo.giftValue}</td>
                    		<td class="f-arial">${bcCouponStatVo.price}</td>
                    		<td class="f-arial">${bcCouponStatVo.totalPrice}</td>
                    		<td class="f-arial">${bcCouponStatVo.giftMoney}</td>
                    		<td class="f-arial">${bcCouponStatVo.giftLeftMoney}</td>
                    		<td class="f-arial">${bcCouponStatVo.getTime}</td>
                    		<td class="f-arial">${bcCouponStatVo.userTime}</td>
                    		<td class="f-arial">${bcCouponStatVo.upLineTime}</td>
                    		<td class="f-arial">${bcCouponStatVo.createOn}</td>
                    	</tr>
                   	</s:iterator>
            </table>
...
<form action="../bcCouponStatAction/bcCouponStatList.action" method="post" style="display: none;" id="turnPage">
