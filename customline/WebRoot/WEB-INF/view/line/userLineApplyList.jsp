...
<title>线路管理-招募线路-用户线路列表-报名人数列表页面</title>
       	...
       	<div style="overflow-x:auto;overflow-y:hidden">
              <table width="100%" border="0" class="table3" id="tableDiv">
                    <tr align="center" class="th">
                      ...
                      <th scope="col" width="7%">乘客昵称/ID</th>
                      <th scope="col" width="7%">联系电话</th>
                    </tr>
                    ...
                    <s:iterator value="list" var="p" status="s">
						...
						<th>${s.index+1}</th>
                    	<td class="f-arial">${p.nickName}/${p.displayId}</td>
...
<form action="../line/getUserLineApplyList.action" method="post" style="display: none;" id="turnPage">
