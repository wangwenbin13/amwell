    ...
    <s:form id="addForm" action="line/saveLineData.action" method="post" theme="simple">
	    <ul class="mt30 ml45 gray2 r-input32" id="addLineUl">
	    		...
	    		<li class="fl widthfull mt15">
	    			...
	    			<input class="fl r-input w235" type="text" id="passengerTel" name="passengerTel" value="${lineDetailVo.passengerTel}" maxlength="11" onblur="checkTelephone(this);"/>
	    			<span class="fl ml4 mr4 mt10">发起人票价：</span>
	    			<input class="fl r-input w235" type="text" id="passengerCoupon" name="passengerCoupon" value="${lineDetailVo.passengerCoupon}" onkeyup="checkPrice(this);" maxlength="3"/>
	    		</li>
				...
				<li class="fl widthfull mt15">
					...
					<select name="cityCode" id="cityCode" class="fl r-input mr10"><option value="">--选择城市--</option></select>
					<input id="lineName" type="text" name="lineName" maxLength="24" class="fl r-input w235 gray2" value="${lineDetailVo.lineName}" onfocus="if(value==defaultValue){value='';$(this).removeClass('gray3').addClass('gray2');}" onblur="if(!value){value=defaultValue;$(this).removeClass('gray2').addClass('gray3');}" onkeyup="if(/-/.test(this.value)){this.value=this.value.replace(/-/,'');}"/>
				</li>
				<li class="fl widthfull mt15"><span class="fl w106 t-r">途经区域：<em class="red1">*</em></span>
				  <input type="text" name="startArea" value="${lineDetailVo.startArea}" id="startArea" maxLength="24" class="fl r-input w222" onkeyup="if(/-/.test(this.value)){this.value=this.value.replace(/-/,'');}"/>
				  <span class="fl ml4 mr4 mt10">—</span>
				  <input type="text" name="endArea"  value="${lineDetailVo.endArea}" id="endArea" maxLength="24" class="fl r-input w222" onkeyup="if(/-/.test(this.value)){this.value=this.value.replace(/-/,'');}"/>
				</li>
			  ...
			  <s:if test="%{#s.first}">
			      ...
			      <li class="fl widthfull mt15 r-input32" id="addLineFristLi"><span class="fl w106 t-r">上车线路：<em class="red1">*</em></span>
			        <!-- 站点名称 -->
					<input type="text" class="fl r-input w222 gray2" name="stationName" maxLength="24" value="${station.stationName}" id="stationNameStart" check="11" onkeyup="if(/-/.test(this.value)){this.value=this.value.replace(/-/,'');}"/>
					<!-- 经度 -->
					<input id="loniStart" class="fl r-input w222 ml10 mr10 gray2" type="text" name="loni" value="${station.loni}" maxlength='32' onkeyup="if(this.value==this.value2)return;if(this.value.search(/^\d*(?:\.\d*)?$/)==-1)this.value=(this.value2)?this.value2:'';else this.value2=this.value;"/>
					<!-- 纬度 -->
					<input id="latiStart" class="fl r-input w222 mr10 gray2" type="text" name="lati" value="${station.lati}" maxlength='32' onkeyup="if(this.value==this.value2)return;if(this.value.search(/^\d*(?:\.\d*)?$/)==-1)this.value=(this.value2)?this.value2:'';else this.value2=this.value;"/>
					<!-- 站点图片URL -->
			  ...
			  <s:else>
			    <s:if test="%{#s.last}">
			      ...
			      <li class="fl widthfull mt15 r-input32" id="addLineLastLi"><span class="fl w106 t-r"></span>
			        <!-- 站点名称 -->
					<input type="text" class="fl r-input w222 gray2" name="stationName" maxLength="24" value="${station.stationName}" id="stationNameEnd" check="11" onkeyup="if(/-/.test(this.value)){this.value=this.value.replace(/-/,'');}"/>
					<!-- 经度 -->
					<input id="loniEnd" class="fl r-input w222 ml10 mr10 gray2" type="text" name="loni" value="${station.loni}" maxlength='32' onkeyup="if(this.value==this.value2)return;if(this.value.search(/^\d*(?:\.\d*)?$/)==-1)this.value=(this.value2)?this.value2:'';else this.value2=this.value;"/>
					<!-- 纬度 -->
					<input id="latiEnd" class="fl r-input w222 mr10 gray2" type="text" name="lati" value="${station.lati}" maxlength='32' onkeyup="if(this.value==this.value2)return;if(this.value.search(/^\d*(?:\.\d*)?$/)==-1)this.value=(this.value2)?this.value2:'';else this.value2=this.value;"/>
					<!-- 站点图片URL -->
			    ...
			    <s:else>
			      ...
			      <li class="fl widthfull mt15 r-input32"><span class="fl w106 t-r"></span>
			        <!-- 站点名称 -->
					<input type="text" class="fl r-input w222 gray2" name="stationName" maxLength="24" value="${station.stationName}" id="stationNameAccess${s.index}" onkeyup="if(/-/.test(this.value)){this.value=this.value.replace(/-/,'');}"/>
					<!-- 经度 -->
					<input id="loniAccess${s.index}" class="fl r-input w222 ml10 mr10 gray2" type="text" name="loni" value="${station.loni}" maxlength='32' onkeyup="if(this.value==this.value2)return;if(this.value.search(/^\d*(?:\.\d*)?$/)==-1)this.value=(this.value2)?this.value2:'';else this.value2=this.value;"/>
					<!-- 纬度 -->
					<input id="latiAccess${s.index}" class="fl r-input w222 mr10 gray2" type="text" name="lati" value="${station.lati}" maxlength='32' onkeyup="if(this.value==this.value2)return;if(this.value.search(/^\d*(?:\.\d*)?$/)==-1)this.value=(this.value2)?this.value2:'';else this.value2=this.value;"/>
					<!-- 站点图片URL -->
					...
					<span id="linePoint${s.index}" count="${s.index}">途径点${s.index}</span>
					<a href="javascript:void(0)" class="f12 blue1 ml10" onclick="deleteAccessPoint(this)">删除</a>
				...
				<li class="fl widthfull mt15"><span class="fl w106 t-r">预计行程时间：<em class="red1">*</em></span>
				    <input type="text" id="lineTime" name="lineTime" value="${lineDetailVo.lineTime}" maxLength="6" class="fl r-input w235" check="2"/>
					<select class="p3 ml10" id="lineTimeType" name="lineTimeType" onchange="changeLineTime();">
						<option value="0" <s:if test="%{lineDetailVo.lineTimeType==0}">selected</s:if>>分钟</option>
						<option value="1" <s:if test="%{lineDetailVo.lineTimeType==1}">selected</s:if>>小时</option>
					</select>
				</li>
				<li class="fl widthfull mt15"><span class="fl w106 t-r">里程：<em class="red1">*</em></span>
				     <input type="text" id="lineKm" name="lineKm" value="${lineDetailVo.lineKm}" maxLength="6" class="fl r-input w235 mr5" check="2"/>KM
				</li>
				<li class="fl widthfull mt15"><span class="fl w106 t-r">选择线路类型：<em class="red1">*</em></span>
					<span class="fl mt5">
						<input type="radio" name="lineType" class="checkbox" checked="checked" value="0"/>上下班
						<input type="radio" name="lineType" class="checkbox ml10" value="1"/>旅游
					</span>
				</li>
...
function changeLineTime(){
	...
	function goAddMapPage(id,loniId,latiId)
	{
		...
		$("#topHide", parent.window.document).show();
	    $("#leftHide", parent.window.document).show();
	    $("#showPage").load("line/addLineMap.action?random="+Math.floor(Math.random()*10000+1),{id:id,lon:lon,lat:lat}); 
	    $("#mainBody").show();
	}
	...
	function addAccessPoint()
	{
		 ...
		 $("#addLineFristLi").after("<li class='fl widthfull mt15 r-input32'>"+
					...
					"<input type='text' name='stationName' maxLength='24' id='stationNameAccess"+count+"' class='fl r-input w222 gray3' value='设置途径点"+count+"' onfocus='if (value==defaultValue){value=\"\";$(this).removeClass(\"gray3\").addClass(\"gray2\");}' onblur='if(!value){value=defaultValue;$(this).removeClass(\"gray2\").addClass(\"gray3\");}' onkeyup='if(/-/.test(this.value)){this.value=this.value.replace(/-/,\"\");}'/>"+
					"<input id='loniAccess"+count+"' class='fl r-input w222 ml10 mr10 gray3' value='经度' type='text' name='loni' maxlength='32' onkeyup='replaceNum(this);'/>"+
					"<input id='latiAccess"+count+"' class='fl r-input w222 mr10 gray3' value='纬度' type='text' name='lati' maxlength='32' onkeyup='replaceNum(this);'/>"+
	...
	function addAccessPointPreOrNext(index)
	{
		...
		$("#stationNameAccess"+parseInt(index)).parent("li").after("<li class='fl widthfull mt15 r-input32'>"+
				"<span class='fl w106 t-r'></span><input type='text' name='stationName' maxLength='24' id='stationNameAccess"+count+"' class='fl r-input w222 gray3' value='设置途径点"+count+"' onfocus='if (value==defaultValue){value=\"\";$(this).removeClass(\"gray3\").addClass(\"gray2\");}' onblur='if(!value){value=defaultValue;$(this).removeClass(\"gray2\").addClass(\"gray3\");}' onkeyup='if(/-/.test(this.value)){this.value=this.value.replace(/-/,\"\");}'/>"+
				"<input id='loniAccess"+count+"' class='fl r-input w222 ml10 mr10 gray3' value='经度' type='text' name='loni' maxlength='32' onkeyup='replaceNum(this);'/>"+
				"<input id='latiAccess"+count+"' class='fl r-input w222 mr10 gray3' value='纬度' type='text' name='lati' maxlength='32' onkeyup='replaceNum(this);'/>"+
				"<input id='picUrlAccess"+count+"' type='hidden' name='picUrl'/>"+
	...
	function setOtherAccessPointNotEqOne()
	{
		...
		for(var i = 0;i < surplusCount;i++)
		{
			if(i != 0 && i != (surplusCount - 1))
			{
				...
				$("[name='stationName']").eq(i).parent("li").find("a").eq(2).attr({"id":"btnB"+parseInt(i),"onclick":"goAddMapPage('Access"+parseInt(i)+"')"});
...
//	 				parent.showRturnTip("输入正确！",true); 
	...
	function checkPrice(obj){
		return obj.value=obj.value=obj.value.replace(/\D/g,'');
	}
</script>
