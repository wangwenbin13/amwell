...
<div class="r-sub-nav-out"><p class="r-sub-nav gray2">当前位置：首页&nbsp;>&nbsp;线路列表</p></div>
            ...
            <div class="table-title">
                <ul>
                    ...
                    <s:iterator value="#request.threeLevelMenu" var="p" status="v">
                		...
                		<li <c:if test="${line_theTab == 1 && v.index == 0 }">class="on"</c:if><c:if test="${line_theTab == 2 && v.index == 1 }">class="on"</c:if>>
