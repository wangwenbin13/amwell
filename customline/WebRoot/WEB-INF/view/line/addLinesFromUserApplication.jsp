    ...
    <s:form id="addForm" action="line/saveLineData.action" method="post" theme="simple">
	    <ul class="mt30 ml45 gray2 r-input32" id="addLineUl">
	    		...
	    		<li class="fl widthfull mt15">
	    			...
	    			<input class="fl r-input w235" type="text" id="passengerTel" name="passengerTel" value="${userLineEntity.telephone}" maxlength="11" onblur="checkTelephone(this);"/>
	    			<span class="fl ml4 mr4 mt10">发起人票价：</span>
	    			<input class="fl r-input w235" type="text" id="passengerCoupon" name="passengerCoupon" value="0" onkeyup="checkPrice(this);" maxlength="3"/>
	    		</li>
				...
				<li class="fl widthfull mt15">
					...
					<input id="lineName" type="text" name="lineName" maxLength="24" class="fl r-input w235 gray2" value="线路名称" onfocus="if(value==defaultValue){value='';$(this).removeClass('gray3').addClass('gray2');}" onblur="if(!value){value=defaultValue;$(this).removeClass('gray2').addClass('gray3');}" onkeyup="if(/-/.test(this.value)){this.value=this.value.replace(/-/,'');}"/>
				</li>
				<li class="fl widthfull mt15"><span class="fl w106 t-r">途经区域：<em class="red1">*</em></span>
				  <input type="text" name="startArea" value="" id="startArea" maxLength="24" class="fl r-input w235" onkeyup="if(/-/.test(this.value)){this.value=this.value.replace(/-/,'');}"/>
				  <span class="fl ml4 mr4 mt10">—</span>
				  <input type="text" name="endArea"  value="" id="endArea" maxLength="24" class="fl r-input w235" onkeyup="if(/-/.test(this.value)){this.value=this.value.replace(/-/,'');}"/>
				</li>
				...
				<s:iterator value="userLineEntity.stationList" var="station" status="s">
			  <s:if test="%{#s.first}">
			      <!-- 起点 -->
			      <li class="fl widthfull mt15 r-input32" id="addLineFristLi"><span class="fl w106 t-r">上车线路：<em class="red1">*</em></span>
			        <!-- 站点名称 -->
					<input type="text" class="fl r-input w235 gray2" name="stationName" maxLength="24" value="${station.stationName}" id="stationNameStart" check="11" onkeyup="if(/-/.test(this.value)){this.value=this.value.replace(/-/,'');}"/>
					<!-- 经度 -->
					<input id="loniStart" class="fl r-input w235 ml10 mr10 gray2" type="text" name="loni" value="0" maxlength='32' onkeyup="if(this.value==this.value2)return;if(this.value.search(/^\d*(?:\.\d*)?$/)==-1)this.value=(this.value2)?this.value2:'';else this.value2=this.value;"/>
					<!-- 纬度 -->
					<input id="latiStart" class="fl r-input w235 mr10 gray2" type="text" name="lati" value="0" maxlength='32' onkeyup="if(this.value==this.value2)return;if(this.value.search(/^\d*(?:\.\d*)?$/)==-1)this.value=(this.value2)?this.value2:'';else this.value2=this.value;"/>
					<!-- 站点图片URL -->
					<input id="picUrlStart" type="hidden" name="picUrl" value=""/>
			  ...
			  <s:else>
			    <s:if test="%{#s.last}">
			      ...
			      <li class="fl widthfull mt15 r-input32" id="addLineLastLi"><span class="fl w106 t-r"></span>
			        <!-- 站点名称 -->
					<input type="text" class="fl r-input w235 gray2" name="stationName" maxLength="24" value="${station.stationName}" id="stationNameEnd" check="11" onkeyup="if(/-/.test(this.value)){this.value=this.value.replace(/-/,'');}"/>
					<!-- 经度 -->
					<input id="loniEnd" class="fl r-input w235 ml10 mr10 gray2" type="text" name="loni" value="0" maxlength='32' onkeyup="if(this.value==this.value2)return;if(this.value.search(/^\d*(?:\.\d*)?$/)==-1)this.value=(this.value2)?this.value2:'';else this.value2=this.value;"/>
					<!-- 纬度 -->
					<input id="latiEnd" class="fl r-input w235 mr10 gray2" type="text" name="lati" value="0" maxlength='32' onkeyup="if(this.value==this.value2)return;if(this.value.search(/^\d*(?:\.\d*)?$/)==-1)this.value=(this.value2)?this.value2:'';else this.value2=this.value;"/>
					<!-- 站点图片URL -->
					<input id="picUrlEnd" type="hidden" name="picUrl" value=""/>
			    ...
			    <s:else>
			      ...
			      <li class="fl widthfull mt15 r-input32"><span class="fl w106 t-r"></span>
					...
					<!-- 经度 -->
					<input id="loniAccess${s.index}" class="fl r-input w235 ml10 mr10 gray2" type="text" name="loni" value="0" maxlength='32' onkeyup="if(this.value==this.value2)return;if(this.value.search(/^\d*(?:\.\d*)?$/)==-1)this.value=(this.value2)?this.value2:'';else this.value2=this.value;"/>
					<!-- 纬度 -->
					<input id="latiAccess${s.index}" class="fl r-input w235 mr10 gray2" type="text" name="lati" value="0" maxlength='32' onkeyup="if(this.value==this.value2)return;if(this.value.search(/^\d*(?:\.\d*)?$/)==-1)this.value=(this.value2)?this.value2:'';else this.value2=this.value;"/>
					<!-- 站点图片URL -->
					<input id="picUrlAccess${s.index}" type="hidden" name="picUrl" value=""/>
				...
				<li class="fl widthfull mt15"><span class="fl w106 t-r">预计行程时间：<em class="red1">*</em></span>
				    <input type="text" id="lineTime" name="lineTime" value="" maxLength="6" class="fl r-input w235" check="2"/>
				...
				<li class="fl widthfull mt15"><span class="fl w106 t-r">里程：<em class="red1">*</em></span>
				     <input type="text" id="lineKm" name="lineKm" value="" maxLength="6" class="fl r-input w235 mr5" check="2"/>KM
				</li>
				<li class="fl widthfull mt15"><span class="fl w106 t-r">选择线路类型：<em class="red1">*</em></span>
					<span class="fl mt5">
						<input type="radio" name="lineType" class="checkbox" value="0"/>上下班
						<input type="radio" name="lineType" class="checkbox ml10" value="1"/>旅游
						<input type="radio" name="lineType" class="checkbox ml10" value="2" checked="checked"/>招募
					</span>
				</li>
