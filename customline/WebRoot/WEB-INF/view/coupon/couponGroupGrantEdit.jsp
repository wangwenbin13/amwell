...
<div class="r-sub-nav-out"><p class="r-sub-nav gray2">当前位置：首页&nbsp;>&nbsp;优惠券管理&nbsp;>&nbsp;优惠券发放编辑页面</p></div>
<s:form id="addForm" theme="simple">
  <div class="mt10 ml20 mr20 black1">
       <div class="table-title">
           <ul>
           	<li class="on"><a href="">优惠券发放编辑</a></li>
           </ul>
       </div>
       <div class="sh-add-new sh-add-new-coupon">  
           <s:hidden name="couponGroupGrant.id"></s:hidden>
...
list="#{' ':'规则名称','telephone':'手机号','registTime':'注册时间','ticketNumber':'购票次数','isDoRecommend':'是否推荐','recommendTime':'推荐时间','isRecommended':'是否被推荐','recommendedTime':'被推荐时间','cityCode':'城市','lineBaseId':'线路','ticketTime':'购票时间','singleHandle':'第三方操作','timingHandle':'第三方定时'}"></s:select>
			   			</td>
			    ...
			    <li class="clearfix" style="margin-left: 120px;"><span style="color:red;">注：多个手机号码之间用英文分号";"隔开，支持txt文件导入手机号</span></li>
			   	...
			   	<s:select name="couponGroupGrant.selectPass" list="#{'oldUser':'现有用户','newUser':'新进用户'}" cssClass="r-input w210" disabled="true"></s:select>
			   	<s:hidden name="couponGroupGrant.modeOfExecution"></s:hidden>
			   	</li>
...
function adminFormSubmit(submitForm){
	...
	$("#"+submitForm).ajaxSubmit({
		type : 'post',
		data:{},
		url : "../couponGroupGrant/couponGroupGrantEdit.action",
		dataType:"text",
		success : function(data) {
			if(1 == data){
