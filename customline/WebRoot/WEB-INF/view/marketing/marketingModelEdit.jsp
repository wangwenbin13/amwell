...
<div class="r-sub-nav-out"><p class="r-sub-nav gray2">当前位置：首页&nbsp;>&nbsp;短信管理&nbsp;>&nbsp;编辑短信模板</p></div>
...
function adminFormSubmit(){
	...
	$("#addSMSTemplate").ajaxSubmit({
		type : 'post',
		data:{},
		url : "../marketing/editMarketingModel.action?random="+Math.floor(Math.random()*10000+1),
		dataType:"text",
