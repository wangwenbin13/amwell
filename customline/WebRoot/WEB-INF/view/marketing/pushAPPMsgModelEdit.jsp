...
<div class="r-sub-nav-out"><p class="r-sub-nav gray2">当前位置：首页&nbsp;>&nbsp;App消息&nbsp;>&nbsp;编辑消息模板</p></div>
<div class="mt10 ml20 mr20 black1">
    ...
    <ul class="mt25 ml10">
      	<li class="w58p mb10 clearfix"><span class="w75 t-r fl">模板名称：</span>                		
          	<s:textfield type="text" theme="simple" cssClass="r-input w50p fl" maxlength="30" name="msgTemplateVo.template_name" id="template_name"  check="11"></s:textfield>
      	</li>
...
function adminFormSubmit(){
	...
	$("#addSMSTemplate").ajaxSubmit({
		type : 'post',
		data:{},
		url : "../pushMessage/editMarketingModel.action?random="+Math.floor(Math.random()*10000+1),
		dataType:"text",
