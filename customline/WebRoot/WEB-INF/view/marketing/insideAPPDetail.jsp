...
<div class="r-sub-nav-out"><p class="r-sub-nav gray2">当前位置：首页&nbsp;>&nbsp;站内信&nbsp;>&nbsp;站内信详情</p></div>
<div class="mt10 ml20 mr20 black1">
 	<div class="table-title">
        <ul>
        	<li class="on"><a href="javascript:void(0)" class="f14 blue2">站内信详情</a></li>
        </ul>
    </div>
   ...
   <s:iterator value="msgModel" var="app" status="s">
    	<ul class="marLi clearfix f12">
            ...
            <s:if test="%{#app.picUrl!=null &&  #app.picUrl!=''}">
	       		<li class="w58p mb10 clearfix" style="height:auto;"><span class="w95 t-r fl">站内信图片：</span>
	       			<div class="fl appSendImg" onclick="goViewPicPage()" id="driving_licence_img">
		            <img src="${app.picUrl }" id="driving_licence"/>
		            </div>
