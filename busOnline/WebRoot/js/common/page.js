...
var pageSize = parseInt($("#pageSize").val());//每页显示的条数

var totalCount = parseInt($("#totalCount").val());//总条数

var currPage = parseInt($("#currPage").val());//当前页码
...
function createDivPageFrame(pageNum)
{
	...
	for(var i = 1; i <= maxSize;i++)
	{
		...
		$("#pageNumDiv").append("<li><a id=\"goPage"+newWriteSize+"\" href=\"javascript:void(0);\" onclick=\"goToPage("+newWriteSize+");\">"+newWriteSize+"</a></li>");	
		//当前页不显示a标签可点的样式
...
{ 
    ...
    $("#searchform").submit();///////////////////////////////////////////////注意form表单ID名字
    checkShowPage(currPage);
