...
import com.util.weixin.MD5Util;
import com.util.weixin.TenpayUtil;
...
public class RequestHandler {
	...
	public void init(String app_id, String app_secret, String app_key, String partner_key) {
		this.last_errcode = "0";
		this.debugInfo = "";
		this.key = PropertiesConfig.WEIXIN_PARTNERSECRET;
	}
	...
	public String genPackage(SortedMap<String, String> packageParams)
		...
		while (it.hasNext()) {
			...
			String k = (String) entry.getKey(), v = (String) entry.getValue();
	...
	public String createSign(SortedMap<String, String> packageParams) {
		...
		sb.append("key=" + PropertiesConfig.WEIXIN_PARTNERSECRET);
		//V3版本不需要加密
		String sign = MD5Util.MD5Encode(sb.toString(), null).toUpperCase();
		return sign;
	}
	...
	public String parseXML() {
		...
		while (it.hasNext()) {
			Map.Entry entry = (Map.Entry) it.next();
			String k = (String) entry.getKey(), v = (String) entry.getValue();
			if (!StringUtils.isEmpty(v) && !"appkey".equals(k)) {
