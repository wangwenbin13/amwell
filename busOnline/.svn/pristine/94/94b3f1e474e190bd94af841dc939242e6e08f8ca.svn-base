package com.service.alipay.util;
...
import com.service.alipay.util.httpClient.HttpProtocolHandler;
import com.service.alipay.util.httpClient.HttpRequest;
import com.service.alipay.util.httpClient.HttpResponse;
import com.service.alipay.util.httpClient.HttpResultType;
import com.service.alipay.sign.MD5;
import com.service.alipay.sign.RSA;
...
public class AlipaySubmit {
    ...
    public static String buildRequest(String ALIPAY_GATEWAY_NEW, Map<String, String> sParaTemp, String strMethod, String strButtonName) {
        ...
        sbHtml.append("<form id=\"orderDetailFrom\" name=\"orderDetailFrom\" action=\"");
        sbHtml.append(ALIPAY_GATEWAY_NEW);
        sbHtml.append("_input_charset=");
        sbHtml.append(AlipayConfig.input_charset);
