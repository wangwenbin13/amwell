...
//	MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQDS3jyqF2LZZXq8Bt5JpGPbNFATPlvM1nNlerBTyBztc37/V8AV1NGbzvuXo0xeQWGTfgLtMYq2w/SOHlIOsXNJT71yNVhNbuvbp8sw8rsXONnAHZ+zmtroFd73LDpEE//4S8svBcbx010o/+9kxEtxir5WEQYD2bXhMJN3eoC7twIDAQAB
	...
	//支付宝充值返回结果
	public static String RECHARG_BACK_RUL = PropertyManage.get("RECHARG_BACK_RUL");
	
	//支付宝充值返回结果
	public static String RECHARG_BACK_RUL_PAY = PropertyManage.get("RECHARG_BACK_RUL_PAY");
	
	//支付宝充值返回结果(包车)
	public static String RECHARG_BACK_RUL_PAY_BC = PropertyManage.get("RECHARG_BACK_RUL_PAY_BC");
