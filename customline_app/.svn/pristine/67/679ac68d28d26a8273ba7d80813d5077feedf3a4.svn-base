...
public interface IBookService {
	...
	/** 评论列表 **/
	public List<AppVo_6> commentList(int currentPage, int pageSize,
			String lineBaseId);
	...
	/** 可用优惠券列表 **/
	public List<AppVo_10> getMyGif(String orderPrice, String userid,
			int currentPage, int pageSize, String type);
	...
	/** 改签日期列表 **/
	public List<AppVo_6> changeDateList(String orderNo, int currentPage,
			int pageSize);
	...
	/** 退票 **/
	public int returnTicket(String localIds, String lineClassIds,
			String orderNo, AppVo_5 vo_4, String payType, String version);

	/************************************************************************* 新增接口（V2.0） ***********************************************************************/

	/** 班车详情 **/
	public AppVo_15_list getLineAndClassInfo(String lineBaseId, String slineId,
			String passengerid);

	/** (新版)改签或退票列表 **/
	public AppVo_15_list changeOrReturn(String orderNo, String userid,
			Integer type);
	...
	/** 车票预定（按次购买V2.0新增接口） **/
	public String bookLineByDays_new(String lineBaseid, String lineSplitId,
			String lineClassIds, String userid, String userType, String gifId);
	...
	/** 订单列表v2.1 **/
	public List<AppVo_18> getOrderListByV2_1(String userid, String orderType,
	...
	public boolean checkReturnCount(String localIds, String lineClassIds,
			String orderNo, String passengerId, String a3);
